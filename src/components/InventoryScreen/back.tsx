...
function getBackImage(backName: string) {
    ...
    switch (backName) {
        case mutations.other.skinWings.name:
            result = <img src={images.bodyElements.mutations.skinWings} alt={chrome.i18n.getMessage('skin_wings')} />;
            break;
        case mutations.other.featherWings.name:
            result = <img src={images.bodyElements.mutations.featherWings} alt={chrome.i18n.getMessage('feather_wings')} />;
            break;
        case mutations.armors.spikedShell.name:
            result = <img src={images.bodyElements.mutations.spikedShell} alt={chrome.i18n.getMessage('spiked_shell')} />;
            break;
        ...
        case items.other.greatSheath.name:
            result = <img src={images.bodyElements.ammunition.greatSheath} alt={chrome.i18n.getMessage('great_sheath')} />;
            break;
        default:
            break;
    }
