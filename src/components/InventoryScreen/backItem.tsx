...
function getBackItemImage(backItem: string) {
    ...
    switch (backItem) {
        case items.weapons.steelGreatsword.name:
            result = <img src={images.bodyElements.greatSwordGreatSheath} alt={chrome.i18n.getMessage('steel_greatsword')} />;
            break;
        case guildItems.weapons.runicGreatsword.name:
            result = <img src={images.bodyElements.greatSwordGreatSheath} alt={chrome.i18n.getMessage('runic_greatsword')} />;
            break;
        default:
            break;
    }
